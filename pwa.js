...
const cacheName = 'AlexTaylorKatieWhittelseyFinal375Project-2020-05-01 10:39:59.551483'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'AlexTaylorKatieWhittelseyFinal375Project'.length) === 'AlexTaylorKatieWhittelseyFinal375Project') {
